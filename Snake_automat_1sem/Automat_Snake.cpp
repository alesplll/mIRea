...
void init_game()
{
    srand(time(NULL));
    clear_field();
    snake_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/snake.png");
    snake.setTexture(snake_texture);
    head_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/head.png");
    head.setTexture(head_texture);
    none_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/none.png");
    none.setTexture(none_texture);
    trap_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/trap.png");
    trap.setTexture(trap_texture);
    apple_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/apple.png");
    apple.setTexture(apple_texture);
    life_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/life.png");
    life.setTexture(life_texture);
    enemy_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/enemy.png");
    enemy.setTexture(enemy_texture);
    enemy2_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/enemy.png");
    enemy2.setTexture(enemy_texture);
    enemy3_texture.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/enemy.png");
    enemy3.setTexture(enemy_texture);
    font_score.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/score.ttf");
    ...
    font_game_over.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/gameover.ttf");
    ...
    font_menu.loadFromFile("~/Code/C++/mirea/Snake_automat_1sem/menu.ttf");
